...
<head>
    ...
    <title>Coverage for /home/marcin/memeWebsiteEnv/lib/python3.8/site-packages/vote/admin.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/marcin/memeWebsiteEnv/lib/python3.8/site-packages/vote/admin.py</b> :
...
<div id="source">
    <p id="t1" class="run"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="key">from</span> <span class="nam">django</span><span class="op">.</span><span class="nam">contrib</span> <span class="key">import</span> <span class="nam">admin</span>  <span class="com"># NOQA</span>&nbsp;</span><span class="r"></span></p>
